 ...
 */
class PLT_AudioMediaServerDelegate : public PLT_MediaServerDelegate
{
public:
    // class methods
    ...
    PLT_AudioMediaServerDelegate(const char* url_root, const char* file_root, bool use_cache = false);
    virtual ~PLT_AudioMediaServerDelegate();
...
/**
 File Media Server.
 The PLT_AudioMediaServer class is an example of a PLT_MediaServer implementation
 for a file system backed Media Server.
 */
class PLT_AudioMediaServer : public PLT_MediaServer,
                            public PLT_AudioMediaServerDelegate
{
public:    // constructor
    PLT_AudioMediaServer(const char*  file_root,
        ...
        PLT_MediaServer(friendly_name, 
                        ...
                        port,
                        port_rebind),
        PLT_AudioMediaServerDelegate("/", file_root) {SetDelegate(this);}

protected:
    virtual ~PLT_AudioMediaServer() {}
};
